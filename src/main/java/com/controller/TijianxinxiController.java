...
public class TijianxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,TijianxinxiEntity tijianxinxi,
		...
		if(tableName.equals("yonghu")) {
			tijianxinxi.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yisheng")) {
			tijianxinxi.setYishengzhanghao((String)request.getSession().getAttribute("username"));
		}
