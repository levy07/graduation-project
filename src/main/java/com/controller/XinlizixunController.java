...
public class XinlizixunController {
    ...
    public R page(@RequestParam Map<String, Object> params,XinlizixunEntity xinlizixun,
		...
		if(tableName.equals("huli")) {
			xinlizixun.setHulizhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			xinlizixun.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
