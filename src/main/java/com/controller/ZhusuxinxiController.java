...
public class ZhusuxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZhusuxinxiEntity zhusuxinxi,
		...
		if(tableName.equals("yonghu")) {
			zhusuxinxi.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("huli")) {
			zhusuxinxi.setHulizhanghao((String)request.getSession().getAttribute("username"));
		}
