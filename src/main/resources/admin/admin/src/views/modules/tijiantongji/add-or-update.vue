<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体检人数" prop="tijianrenshu">
          <el-input v-model="ruleForm.tijianrenshu" 
              placeholder="体检人数" clearable  :readonly="ro.tijianrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体检人数" prop="tijianrenshu">
              <el-input v-model="ruleForm.tijianrenshu" 
                placeholder="体检人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tongjishijian = true;
          ...
          if(o=='tijianrenshu'){
            this.ruleForm.tijianrenshu = obj[o];
	    this.ro.tijianrenshu = true;
            continue;
          }
          if(o=='beizhu'){
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springboot066l2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tijiantongji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tijiantongjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
