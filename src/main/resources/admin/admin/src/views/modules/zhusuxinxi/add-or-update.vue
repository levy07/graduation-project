<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="住宿编号" prop="zhusubianhao">
            <el-input v-model="ruleForm.zhusubianhao" 
                placeholder="住宿编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhusubianhao" label="住宿编号" prop="zhusubianhao">
              <el-input v-model="ruleForm.zhusubianhao" 
                placeholder="住宿编号" readonly></el-input>
          </el-form-item>
        </div>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhusubianhao'){
            this.ruleForm.zhusubianhao = obj[o];
	    this.ro.zhusubianhao = true;
            continue;
          }
          if(o=='fanghao'){
