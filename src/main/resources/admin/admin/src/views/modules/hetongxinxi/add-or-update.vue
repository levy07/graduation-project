<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.wenjian" label="文件" prop="wenjian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.wenjian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="签订期限" prop="qiandingqixian">
          <el-input v-model="ruleForm.qiandingqixian" 
              placeholder="签订期限" clearable  :readonly="ro.qiandingqixian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="签订期限" prop="qiandingqixian">
              <el-input v-model="ruleForm.qiandingqixian" 
                placeholder="签订期限" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.qiandingriqi = this.getCurDateTime()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yonghuxingming = true;
          ...
          if(o=='qiandingqixian'){
            this.ruleForm.qiandingqixian = obj[o];
	    this.ro.qiandingqixian = true;
            continue;
          }
          if(o=='qiandingriqi'){
