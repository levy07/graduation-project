    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="记录编号" prop="jilubianhao">
            <el-input v-model="ruleForm.jilubianhao" 
                placeholder="记录编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jilubianhao" label="记录编号" prop="jilubianhao">
              <el-input v-model="ruleForm.jilubianhao" 
                placeholder="记录编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="护理详情" prop="hulixiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.hulixiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.hulixiangqing" label="护理详情" prop="hulixiangqing">
                    <span v-html="ruleForm.hulixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shentizhuangkuang = true;
          ...
          if(o=='hulixiangqing'){
            this.ruleForm.hulixiangqing = obj[o];
	    this.ro.hulixiangqing = true;
            continue;
          }
          if(o=='hulizhanghao'){
	...
	this.ruleForm.hulixiangqing = this.ruleForm.hulixiangqing.replace(reg,'../../../springboot066l2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
