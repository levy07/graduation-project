<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="护理编号" prop="hulibianhao">
            <el-input v-model="ruleForm.hulibianhao" 
                placeholder="护理编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.hulibianhao" label="护理编号" prop="hulibianhao">
              <el-input v-model="ruleForm.hulibianhao" 
                placeholder="护理编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="护理方案" prop="hulifangan">
          <el-input v-model="ruleForm.hulifangan" 
              placeholder="护理方案" clearable  :readonly="ro.hulifangan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="护理方案" prop="hulifangan">
              <el-input v-model="ruleForm.hulifangan" 
                placeholder="护理方案" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="饮食" prop="yinshi">
          <el-input v-model="ruleForm.yinshi" 
              placeholder="饮食" clearable  :readonly="ro.yinshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="饮食" prop="yinshi">
              <el-input v-model="ruleForm.yinshi" 
                placeholder="饮食" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='hulibianhao'){
            this.ruleForm.hulibianhao = obj[o];
	    this.ro.hulibianhao = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
	    ...
	    this.ro.yonghuxingming = true;
          ...
          if(o=='hulifangan'){
            this.ruleForm.hulifangan = obj[o];
	    this.ro.hulifangan = true;
            continue;
          }
          if(o=='yinshi'){
            this.ruleForm.yinshi = obj[o];
	    this.ro.yinshi = true;
            continue;
          }
          if(o=='yaofang'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../springboot066l2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `hulifangan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.hulifanganCrossAddOrUpdateFlag = false;
						 this.parent.search();
