    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="项目名称" prop="xiangmumingcheng">
          <el-select :disabled="ro.xiangmumingcheng" @change="xiangmumingchengChange" v-model="ruleForm.xiangmumingcheng" placeholder="请选择项目名称">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.xiangmumingcheng" label="项目名称" prop="xiangmumingcheng">
...
export default {
  ...
  methods: {
    ...
    // 下二随
    xiangmumingchengChange () {
      this.$http({
        url: `follow/xiangmuxinxi/xiangmumingcheng?columnValue=`+ this.ruleForm.xiangmumingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
