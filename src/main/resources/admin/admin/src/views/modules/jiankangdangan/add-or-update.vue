    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="以往病史" prop="yiwangbingshi">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yiwangbingshi" label="以往病史" prop="yiwangbingshi">
                    <span>{{ruleForm.yiwangbingshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jiazubingshi" label="家族病史" prop="jiazubingshi">
                    <span>{{ruleForm.jiazubingshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
