      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
              ...
              <el-form-item :label="contents.inputTitle == 1 ? '年龄' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.nianlingstart" placeholder="最小年龄" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.nianlingstart" placeholder="最小年龄" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.nianlingstart" placeholder="最小年龄" clearable></el-input>
              </el-form-item>
              <el-form-item :label="'至'">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.nianlingend" placeholder="最大年龄" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.nianlingend" placeholder="最大年龄" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.nianlingend" placeholder="最大年龄" clearable></el-input>
              </el-form-item>
          <el-form-item>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.nianlingstart!='' && this.searchForm.nianlingstart!=undefined ){
            params['nianlingstart'] = this.searchForm.nianlingstart
          }
          if(this.searchForm.nianlingend!='' && this.searchForm.nianlingend!=undefined){
            params['nianlingend'] = this.searchForm.nianlingend
          }
      this.$http({
        url: "yonghu/page",
        method: "get",
