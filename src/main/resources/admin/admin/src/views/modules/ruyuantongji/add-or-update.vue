<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="入院人数" prop="ruyuanrenshu">
          <el-input v-model="ruleForm.ruyuanrenshu" 
              placeholder="入院人数" clearable  :readonly="ro.ruyuanrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="入院人数" prop="ruyuanrenshu">
              <el-input v-model="ruleForm.ruyuanrenshu" 
                placeholder="入院人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tongjishijian = true;
          ...
          if(o=='ruyuanrenshu'){
            this.ruleForm.ruyuanrenshu = obj[o];
	    this.ro.ruyuanrenshu = true;
            continue;
          }
          if(o=='beizhu'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `ruyuantongji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.ruyuantongjiCrossAddOrUpdateFlag = false;
						 this.parent.search();
