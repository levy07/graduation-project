<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="理疗编号" prop="liliaobianhao">
            <el-input v-model="ruleForm.liliaobianhao" 
                placeholder="理疗编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.liliaobianhao" label="理疗编号" prop="liliaobianhao">
              <el-input v-model="ruleForm.liliaobianhao" 
                placeholder="理疗编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体检结果" prop="tijianjieguo">
          <el-input v-model="ruleForm.tijianjieguo" 
              placeholder="体检结果" clearable  :readonly="ro.tijianjieguo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体检结果" prop="tijianjieguo">
              <el-input v-model="ruleForm.tijianjieguo" 
                placeholder="体检结果" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="理疗方案" prop="liliaofangan">
          <el-input v-model="ruleForm.liliaofangan" 
              placeholder="理疗方案" clearable  :readonly="ro.liliaofangan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="理疗方案" prop="liliaofangan">
              <el-input v-model="ruleForm.liliaofangan" 
                placeholder="理疗方案" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="理疗时间" prop="liliaoshijian">
          <el-input v-model="ruleForm.liliaoshijian" 
              placeholder="理疗时间" clearable  :readonly="ro.liliaoshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="理疗时间" prop="liliaoshijian">
              <el-input v-model="ruleForm.liliaoshijian" 
                placeholder="理疗时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="理疗项目" prop="liliaoxiangmu">
          <el-input v-model="ruleForm.liliaoxiangmu" 
              placeholder="理疗项目" clearable  :readonly="ro.liliaoxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="理疗项目" prop="liliaoxiangmu">
              <el-input v-model="ruleForm.liliaoxiangmu" 
                placeholder="理疗项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='liliaobianhao'){
            this.ruleForm.liliaobianhao = obj[o];
	    this.ro.liliaobianhao = true;
            continue;
          }
          if(o=='tijianjieguo'){
	    ...
	    this.ro.tijianjieguo = true;
          ...
          if(o=='liliaofangan'){
            this.ruleForm.liliaofangan = obj[o];
	    this.ro.liliaofangan = true;
            continue;
          }
          if(o=='liliaoshijian'){
            this.ruleForm.liliaoshijian = obj[o];
	    this.ro.liliaoshijian = true;
            continue;
          }
          if(o=='liliaoxiangmu'){
            this.ruleForm.liliaoxiangmu = obj[o];
	    this.ro.liliaoxiangmu = true;
            continue;
          }
          if(o=='yonghuzhanghao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `liliaoxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.liliaoxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
