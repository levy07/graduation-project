  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="工龄" class="input" v-if="tableName=='yisheng'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='huli'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='huli'" class="input-group">
			...
			<el-form-item label="部门" class="input" v-if="tableName=='huli'">
			...
			<el-form-item label="电话号码" class="input" v-if="tableName=='huli'">
			  <el-input v-model="ruleForm.dianhuahaoma" autocomplete="off" placeholder="电话号码"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.hulizhanghao) && `huli` == this.tableName){
        this.$message.error(`护理账号不能为空`);
        return
      }
      if((!this.ruleForm.hulixingming) && `huli` == this.tableName){
        this.$message.error(`护理姓名不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `huli` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if(`huli` == this.tableName && this.ruleForm.dianhuahaoma&&(!this.$validate.isMobile(this.ruleForm.dianhuahaoma))){
        this.$message.error(`电话号码应输入手机格式`);
        return
      }
      this.$http({
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20211129/9637199016ae4c8eae3702436cdb6aac.png);
